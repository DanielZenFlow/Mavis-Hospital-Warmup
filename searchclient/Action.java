...
public enum Action
{
    ...
    */
    ...
    // Push actions: agent moves into box cell (agentDir), box moves out (boxDir)
    // boxDir != opposite(agentDir), so 4x3 = 12 valid combinations
    ...
    // Pull actions: agent moves away (agentDir), box follows into agent's old cell (boxDir)
    // boxDir != opposite(agentDir), so 4x3 = 12 valid combinations
